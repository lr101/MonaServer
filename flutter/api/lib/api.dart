...
part 'api/group_pin_designs_api.dart';
...
part 'model/group_pin_design_badge.dart';
part 'model/group_pin_design_catalog_dto.dart';
part 'model/group_pin_design_dto.dart';
part 'model/group_pin_design_shape.dart';
part 'model/group_pin_design_style.dart';
...
part 'model/update_group_pin_design_catalog_dto.dart';
