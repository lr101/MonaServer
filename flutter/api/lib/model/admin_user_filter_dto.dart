...
class AdminUserFilterDto {
  ...
  @override
  String toString() => 'AdminUserFilterDto[createdAfter=$createdAfter, createdBefore=$createdBefore, email=$email, id=$id, includeAdmins=$includeAdmins, securityStatuses=$securityStatuses, username=$username, verifiedEmail=$verifiedEmail]';
