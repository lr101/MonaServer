...
class GlobalDataService extends _$GlobalDataService {
  ...
  Future<void> logout() async {
    // Invalidate the in-memory session before awaiting storage cleanup. Any
    // request that finishes during that await must fail its session guard and
    // stay out of the next account's cache.
    state = GlobalDataDto(
      userId: null,
      refreshToken: null,
